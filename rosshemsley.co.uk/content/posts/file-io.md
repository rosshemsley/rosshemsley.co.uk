...
Here's an example of a library I wrote that reads MNIST data, providing two APIs for reading data from path or from a reader, [MNIST reader](https://github.com/rosshemsley/gonn/blob/master/mnist/mnist.go#L16).
